function [ centers ] = sift_centers( fileList, HOMEIMAGES, testImgIdx, dictionarySize)
%MAX_RESP_CENTERS Summary of this function goes here
%   Detailed explanation goes here
SIFTparam.grid_spacing = 1;
SIFTparam.patch_size = 16;
%[uV sV] = memory;
ndata_max = 10000 % min(sV.PhysicalMemory.Available/512/10,100000); %use 10% avalible memory if its smaller than the default
