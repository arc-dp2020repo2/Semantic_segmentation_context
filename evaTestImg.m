function evaTestImg(matFold,allImgList,testImgIdx,numClass,selClf,selInt,SelFeaIdx,sumLocPriorMap,adjSuperPixelOcc,coef,blockrow,sta,iCV)
...
% 
        ...
        if 1
            ...
            [gtHeight, gtWidth] = size(imgGT);
            %TT = reshape(imgGT,[gtHeight, gtWidth]); %%preLabel
            TT = reshape(preLabel3,[gtHeight, gtWidth]);
